...
namespace Catamaran.TerrainGenerator
{
    public class TerrainChunk
    {
        ...
        public TerrainChunk(GameObject _parentGOBJ, TerrainChunkSettings settings, NoiseProvider noiseProvider, int x, int z)
        {
        ...
        public void CreateTerrain()
        {
			...
			newTerrainGameObject.transform.parent = _ParentGOBJ.transform;
			newTerrainGameObject.transform.localPosition = Vector3.zero;
