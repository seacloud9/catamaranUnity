	...
	public class CoolestTween : MonoBehaviour
	{
		...
		*/
		...
		public static CTweenController alphaTo (Transform gameObject, float to, float duration, CTweenConfig descriptor = null)
		{
			...
			CTweenDesc desc = getTween ();
			desc.target = gameObject;
			desc._renderer = gameObject.GetComponent<Renderer> ();
			...
			if (gameObject.GetComponent<Renderer> () is SpriteRenderer)
				desc.startValue = new Vector3 ((gameObject.GetComponent<Renderer> () as SpriteRenderer).color.a, 0, 0);
			else
				desc.startValue = new Vector3 (gameObject.GetComponent<Renderer> ().sharedMaterial.color.a, 0, 0);
		...
		public static CTweenController colorTo (Transform gameObject, Color to, float duration, CTweenConfig descriptor = null)
		{
			...
			Color color;
			if (gameObject.GetComponent<Renderer> () is SpriteRenderer)
				color = (gameObject.GetComponent<Renderer> () as SpriteRenderer).color;
			else
